    ...
    async execute(client, interaction, settings, goodies) {
      ...
      else
      {
            ...
            if (!formula)
            {
                ...
                embed = new EmbedBuilder({description: `Successfully reset Lichess rating equation to default: ${jsGay.Constant_lichessDefaultRatingEquation}`})
                    .setColor(0x0099ff)
            }
            else
            {  
              ...
              embed = new EmbedBuilder({description: `Successfully set Lichess rating equation to: ${formula}`})
                    .setColor(0x0099ff)
            }
      }
