...
let slashCommand = new SlashCommandBuilder()
		.setName('verifyrole')
		.setDescription('Adds a role that is given if verified with any website.')

    .addRoleOption((option) =>
      option.setName('role').setDescription('The role to be given for verified members').setRequired(true))
